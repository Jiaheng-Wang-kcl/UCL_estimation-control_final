...
def main():
    ...
    # Compute final distance from (0, 0)
    final_distance = np.linalg.norm([true_state[0], true_state[1]])

    # Print final metrics
    print(f"Final distance to (0, 0): {final_distance:.2f} meters")
    print(f"Total runtime: {time} milliseconds")
